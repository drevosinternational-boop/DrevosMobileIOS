...
1. In Firebase project `drevos-9827e`, register an Apple app with bundle ID **`com.drevos.smoker`**.
...
8. For a real iPhone/TestFlight build, create the app record for `com.drevos.smoker` in App Store Connect and configure the Codemagic App Store Connect integration named **`codemagic`**.
